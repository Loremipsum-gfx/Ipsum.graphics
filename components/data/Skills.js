const placeholder = './src/assets/bitmap/me.png';

const skills = [
    {
      id: 1,
      image: '/skills-layout.png' || placeholder,
    ...
    {
      id: 2,
      image: '/skills-ux.png' || placeholder,
    ...
    {
      id: 3,
      image: '/skills-illustration.png' || placeholder,
    ...
    {
      id: 4,
      image: '/skills-video-animation.png' || placeholder,
